export default function Program() {
    return (<div className="relative flex min-h-screen flex-col overflow-hidden bg-black-50 py-6 sm:py-12">
        <div className="relative flex min-h-screen flex-col overflow-hidden bg-black-50 py-6 sm:py-12">
        <div className="relative bg-black ml-10 px-10 pt-20 pb-20 shadow-xl ring-1 ring-white-900/5 sm:mx-auto sm:max-w-lg sm:rounded-lg sm:px-10">
        </div>
        </div>
        <img src="/img/beams.jpg" alt="" className="absolute top-1/2 left-1/2 max-w-none -translate-x-1/2 -translate-y-1/2" width="1308" />
        <div className="relative bg-black px-6 pt-10 pb-8 shadow-xl ring-1 ring-white-900/5 sm:mx-auto sm:max-w-lg sm:rounded-lg sm:px-10">
          <div className="mx-auto max-w-md">
            <img src="/img/logo.svg" className="h-6" alt="Tailwind Play" />
            <div className="divide-y divide-white-300/50">
              <div className="space-y-6 py-8 text-base leading-7 text-white">
                ...
                <ul className="space-y-4">
                  <li className="flex items-center">
                    ...
                    <p className="ml-4">
                      Customizing your
                      <code className="text-sm font-bold text-blue-900">tailwind.config.js</code> file
                    </p>
                  </li>
                  <li className="flex items-center">
                    <svg className="h-6 w-6 flex-none fill-sky-100 stroke-sky-500 stroke-2" stroke-linecap="round" stroke-linejoin="round">
